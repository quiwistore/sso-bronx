...
{"slug":"what-is-social-security","silo":"learn",
 ...
 "intro":"Social Security is the largest federal program in the United States, paying benefits to over 70 million people every month. Despite that, most workers do not really understand how it works until they need it. This guide explains the program in plain English: what it is, what it pays for, who qualifies, and the basic mechanics of how a benefit is calculated.",
 "sections":[
   ...
   {"type":"section","heading":"The four major programs Social Security runs",
    "body":[
      "<strong>Retirement Insurance</strong> is the largest and best-known program: monthly benefits to retired workers who paid into the system through payroll taxes. You can start as early as 62 (with reduced benefits) or wait until 70 (for maximum benefits).",
      "<strong>Disability Insurance (SSDI)</strong> pays workers who cannot work due to a medically-determinable disability expected to last at least 12 months or result in death. It is funded by the same payroll taxes as retirement.",
      "<strong>Survivors Insurance</strong> pays the spouse, ex-spouse, children, and sometimes parents of a deceased worker. This is the least-known major program but pays significant benefits to millions of families.",
      "<strong>Supplemental Security Income (SSI)</strong> is administered by the SSA but is a separate, needs-based program funded by general tax revenue rather than payroll taxes. It pays disabled, blind, or elderly people with very limited income and resources. SSI is particularly relevant in the Bronx given the borough's demographics."
    ]},
   ...
   {"type":"faq_extra","items":[
     ...
     {"q":"Can my Social Security benefit be taxed?","a":"Possibly. If your combined income (Social Security + other income) exceeds certain thresholds, up to 85% of your benefit may be subject to federal income tax. New York State exempts Social Security from state income tax, so most New York residents pay no state tax on Social Security benefits."}
   ]}
 ]},
...
{"slug":"ssi-vs-ssdi-difference","silo":"learn",
 ...
 "intro":"SSI and SSDI both pay disability benefits, and both are run by the SSA, but they work very differently and have totally different eligibility rules. Mixing them up is one of the most common mistakes Bronx residents make when applying. This guide explains the differences clearly and helps you understand which program (or both) might apply to you.",
 "sections":[
   ...
   {"type":"troubleshoot","heading":"Side by side comparison",
    "items":[
      ...
      {"q":"Benefit amount","a":"SSDI is based on your past earnings (average around $1,500/month nationally). SSI federal maximum is about $943/month for an individual in 2024, plus a small New York State supplement."},
      {"q":"Health coverage","a":"SSDI recipients become eligible for Medicare after a 24-month waiting period. SSI recipients in New York are generally automatically eligible for Medicaid."},
   ...
   {"type":"section","heading":"Who typically applies for SSI",
    "body":[
      "SSI is the right program for people without enough work history to qualify for SSDI, but who meet the financial limits. The classic cases: young adults who became disabled before working much, elderly people without enough Social Security credits, and children with disabilities in low-income families. The Bronx has one of the highest concentrations of SSI recipients in the United States, given the borough's demographics.",
   ...
   {"type":"faq_extra","items":[
     ...
     {"q":"Do SSI recipients automatically get Medicaid in New York?","a":"In most cases, yes. New York is a 1634 state, which means SSI eligibility automatically conveys Medicaid eligibility. This is one of the most important practical benefits of SSI in the Bronx."},
...
{"slug":"how-to-appeal-disability-denial","silo":"learn",
 "h1":"How to Appeal a Social Security Disability Denial",
 "title":"How to Appeal a Disability Denial in New York (2026)",
 "meta":"Step-by-step guide to appealing a Social Security disability denial in New York. 60-day deadline, four levels of appeal, and how to maximize your chances.",
 "intro":"Around 65% of initial Social Security disability applications are denied — and many of those who eventually receive benefits were denied at first. A denial is not the end of the road. This guide walks through the four-stage appeals process, the strict 60-day deadlines, and how to maximize your chances of approval on appeal in New York.",
 "sections":[
   {"type":"quick_answer","heading":"The quick answer",
    "body":"If your Social Security disability application was denied, you have 60 days from the date of the denial letter to file an appeal. The appeals process has four levels: Reconsideration, Hearing before an Administrative Law Judge, Appeals Council Review, and Federal Court. Many denied applicants are eventually approved — especially at the Hearing stage. Hiring a disability attorney significantly improves your odds of winning, and most work on contingency (no payment if you lose)."},
   {"type":"section","heading":"The 60-day deadline is critical",
    "body":[
      "The single most important fact about appealing a Social Security disability denial: you have <strong>60 days from the date on your denial letter</strong> to file your appeal. Missing this deadline almost always means starting over with a new application, losing months of potential back-benefits.",
   ...
   {"type":"troubleshoot","heading":"The four levels of appeal",
    "items":[
      {"q":"Level 1 - Reconsideration","a":"A different SSA reviewer looks at your case along with any new evidence. About 13% of reconsiderations are approved. File within 60 days of denial. This level is fast but not where most cases are won."},
      {"q":"Level 2 - Hearing before an Administrative Law Judge","a":"This is where many appeals are won. You appear (in person, by video, or by phone) before a federal judge who hears your case. Approval rates at hearings are around 45-55%, dramatically higher than reconsideration. Wait time for a hearing can be 6-12 months."},
      {"q":"Level 3 - Appeals Council Review","a":"If the judge denies your case, you can request review by the Appeals Council. They look for legal errors. They either deny review, send the case back to the judge, or rarely reverse outright. This level takes 6-12 months."},
      {"q":"Level 4 - Federal Court","a":"The final level. You file a lawsuit in federal district court. This is rare and usually requires an attorney. The court can order benefits or send the case back to the SSA."}
    ]},
   {"type":"section","heading":"Why hiring an attorney matters at the Hearing stage",
    "body":[
   ...
   {"type":"faq_extra","items":[
     {"q":"How long does the entire appeals process take?","a":"From initial denial through a Hearing decision, plan for 12-18 months in New York. Further appeals (Appeals Council, Federal Court) add many more months or years."},
     {"q":"Can I work while my appeal is pending?","a":"You can earn up to the Substantial Gainful Activity threshold (~$1,550/month in 2024) without disqualifying yourself. Earning above that level is treated as evidence you are not disabled."},
     {"q":"What happens if I get approved on appeal?","a":"You receive back-benefits dating from when you became eligible (often the application date or your established onset date), minus any waiting periods. This can amount to a substantial lump sum after a long appeals process."},
     {"q":"Can I file a new application instead of appealing?","a":"You can, but it is usually a mistake. A new application restarts the clock and loses any back-benefits you would have earned with the original application date. Appeal the denial — do not start over unless an attorney tells you to."}
   ]}
 ]}
]

json.dump({"learn": learn}, open('data/learn-bronx.json','w',encoding='utf-8'), ensure_ascii=False, indent=2)
print(f"OK LEARN generadas: {len(learn)} paginas")
